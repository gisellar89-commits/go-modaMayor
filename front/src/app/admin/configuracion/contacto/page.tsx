              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    placeholder="¡Hola! Tengo una consulta sobre Moda x Mayor"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                  />
                </div>
                {settings.whatsapp_number && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600 mb-2">Vista previa del enlace:</p>
                    <a
                    ...
                    >
                      https://wa.me/{settings.whatsapp_number}?text={settings.whatsapp_message.substring(0, 30)}...
                    </a>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="contacto@modaxmayor.com"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                  />
                </div>
                <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://facebook.com/modaxmayor"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://instagram.com/modaxmayor"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://twitter.com/modaxmayor"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                  />
                </div>
              </div>
