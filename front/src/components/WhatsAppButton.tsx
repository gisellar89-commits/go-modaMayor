...
export default function WhatsAppButton() {
  ...
  const [config, setConfig] = useState<ContactSettings>({
    whatsapp_number: "5491123456789",
    whatsapp_message: "¡Hola! Tengo una consulta sobre Moda x Mayor",
  });
      ...
      .then(data => {
        if (data.whatsapp_number) {
          setConfig({
            ...
            whatsapp_message: data.whatsapp_message || config.whatsapp_message,
          });
        }
      })
      .catch(err => {
        console.log("Usando configuración por defecto de WhatsApp:", err);
      });
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Botón */}
        <div className="relative w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl">
          <svg
